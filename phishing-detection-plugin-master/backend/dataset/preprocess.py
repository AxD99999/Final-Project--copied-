...
dataset = list(arff.load('dataset.arff'))

check=input("Dataset loaded!")

data = np.array(dataset[0])

check=input("Dataset converted to array!")
...
check=input("Enter key to continue: ")
